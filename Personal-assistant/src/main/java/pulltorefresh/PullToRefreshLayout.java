...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        refreshView = LayoutInflater.from(context).inflate(R.layout.tab_frament1_refresh_head, this, false);
        loadMoreView = LayoutInflater.from(context).inflate(R.layout.tab_fragment1_load_foot, this, false);
        addView(refreshView);
